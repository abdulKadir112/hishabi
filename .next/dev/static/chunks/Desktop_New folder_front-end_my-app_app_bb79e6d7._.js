...
function DonorsList() {
    ...
    const [selectedDonor, setSelectedDonor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$New__folder$2f$front$2d$end$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [filterType, setFilterType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$New__folder$2f$front$2d$end$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all'); // all, top10, bottom10, frequent
    // donors প্রস্তুত করা
    const donors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$New__folder$2f$front$2d$end$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DonorsList.useMemo[donors]": ()=>{
            let list = (members || []).filter({
                "DonorsList.useMemo[donors].list": (m)=>(m.totalDonated || 0) > 0
            }["DonorsList.useMemo[donors].list"]);
            // সার্চ ফিল্টার
            if (searchTerm.trim()) {
                const term = searchTerm.trim().toLowerCase();
                list = list.filter({
                    "DonorsList.useMemo[donors]": (m)=>m.name.toLowerCase().includes(term)
                }["DonorsList.useMemo[donors]"]);
            }
            ...
            switch(filterType){
                case 'top10':
                    return list.sort({
                        "DonorsList.useMemo[donors]": (a, b)=>(b.totalDonated || 0) - (a.totalDonated || 0)
                    }["DonorsList.useMemo[donors]"]).slice(0, 10);
                case 'bottom10':
                    return list.sort({
                        "DonorsList.useMemo[donors]": (a, b)=>(a.totalDonated || 0) - (b.totalDonated || 0)
                    }["DonorsList.useMemo[donors]"]).slice(0, 10);
                case 'frequent':
                    return list.map({
                        "DonorsList.useMemo[donors]": (m)=>({
                                ...m,
                                count: transactions.filter({
                                    "DonorsList.useMemo[donors]": (t)=>t.type === 'donation' && t.donorName?.trim().toLowerCase() === m.name.toLowerCase()
                                }["DonorsList.useMemo[donors]"]).length
                            })
                    }["DonorsList.useMemo[donors]"]).filter({
                        "DonorsList.useMemo[donors]": (m)=>m.count >= 5
                    }["DonorsList.useMemo[donors]"]).sort({
                        "DonorsList.useMemo[donors]": (a, b)=>b.totalDonated - a.totalDonated
                    }["DonorsList.useMemo[donors]"]);
                default:
                    return list.sort({
                        "DonorsList.useMemo[donors]": (a, b)=>(b.totalDonated || 0) - (a.totalDonated || 0)
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$New__folder$2f$front$2d$end$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$New__folder$2f$front$2d$end$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                donors.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$New__folder$2f$front$2d$end$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                selectedDonor && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$New__folder$2f$front$2d$end$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    transactions.filter((t)=>t.type === 'donation' && t.donorName?.trim().toLowerCase() === selectedDonor.name.toLowerCase()).sort((a, b)=>new Date(b.date || b.createdAt || 0) - new Date(a.date || a.createdAt || 0)).map((d, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$New__folder$2f$front$2d$end$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$New__folder$2f$front$2d$end$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: d.date || d.createdAt ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$New__folder$2f$front$2d$end$2f$my$2d$app$2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(d.date || d.createdAt), 'dd MMMM yyyy', {
...
_s(DonorsList, "xTxUdvDNccgjLAF6CYw1eR2+CXE=", false, function() {
    return [
